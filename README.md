...
* Link to the playlist on youtube can be found in the column to the right under the 'About' section.

* I've uploaded three file formats (.f3d, .step, and .stl). Feel free to take a look at the .stl files for a rendered model of my homework design.
